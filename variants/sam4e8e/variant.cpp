...
extern const PinDescription g_APinDescription[]=
{
  ...
  { PIOB, PIO_PA6C_UTXD1|PIO_PA5C_URXD1, ID_PIOB, PIO_PERIPH_A, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_COMBO), NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER }, // DONE
   // 20 - PD0
  { PIOD, PIO_PD0, ID_PIOD, PIO_PERIPH_D, PIO_DEFAULT, PIN_ATTR_DIGITAL, NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER }, // DONE
  // 21 - PA17 
  { PIOA, PIO_PA17, ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT, PIN_ATTR_DIGITAL, NO_ADC, NO_ADC, NOT_ON_PWM, NOT_ON_TIMER }, // DONE  
 // END
